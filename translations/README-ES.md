...
<h1 class="translate">Hola, soy guillerme</h1>

**`Digital Craftsman`**

<h2 class="translate">Mi portafolio personal</h2>

[//]: # (### [My personal portfolio]&#40;https://guilhermecosta.vercel.app/&#41; ✌️)

<p class="translate">Soy un desarrollador de software al que le gusta la emoción de crear soluciones innovadoras y abordar desafíos de manera práctica y eficiente. Aunque tengo más experiencia trabajando en back-end, me gustan mucho las tareas que abarcan todo el proceso de desarrollo, entrelazando elementos de front-end, back-end y base de datos. Me siento cómodo trabajando con Java, Spring Framework, Angular, React Js, SQL y Git. Aprecio las metodologías ágiles y busco nuevas formas de mejorar los procesos, haciéndolos más eficientes.</p>
...
<h2 class="translate">Principales lenguajes y herramientas</h2>
