...
<h1 class="translate">Oi, meu nome é Guilherme</h1>

**`Digital Craftsman`**

<h2 class="translate">Meu portfólio pessoal</h2>

[//]: # (### [My personal portfolio]&#40;https://guilhermecosta.vercel.app/&#41; ✌️)

<p class="translate">Sou um desenvolvedor de software que gosta da emoção de criar soluções inovadoras e enfrentar desafios de forma prática e eficiente. Embora eu tenha mais experiência trabalhando com back-end, gosto genuinamente de tarefas que abrangem todo o processo de desenvolvimento, entrelaçando elementos de front-end, back-end e banco de dados. Sinto-me confortável trabalhando com Java, Spring Framework, Angular, React Js, SQL e Git. Aprecio metodologias ágeis e procuro novas formas de melhorar processos, tornando-os mais eficientes.</p>
...
<h2 class="translate">Principais linguagens e ferramentas</h2>
